...
test('두 자리 수 나눗셈 단원은 몫을 숨기고 K/A/R 활동을 끝낸다', async ({ page }) => {
  ...
  await expect(page.getByText('검증된 단원 13개')).toBeVisible()
