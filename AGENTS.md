...
한국 초등학생이 가입 없이 바로 시작하는 비상업적 개인 수학 학습 웹앱이다. 현재 작업트리는 1·2학년 놀이형 미션, 3·4학년 K/A/R 기본·연습 활동, 5·6학년 개념별 5/10문제 학습을 제공하며 1~6학년 공개 원본 1,622개를 포함한다.
2·3학년 전 단원과 5·6학년 시범 단원에는 프로젝트 책임자가 승인한 응용문제 유형 107개를 기존 학습 흐름에 연결했다. 정적 배포와 기기 로컬 기록을 기본으로 유지하며 서비스 런타임에서 AI를 호출하지 않는다.
...
│           └── AGENTS.md             → 응용문제 지식 묶음·승인 콘텐츠 변경 규칙
├── scripts/
...
└── src/
    ...
    └── lib/
        ...
        └── application-problems/
            └── AGENTS.md             → 응용문제 계약·제작·검증·런타임 경계
```
