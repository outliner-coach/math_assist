...
3. 5학년 응용문제 품질 경고 31개를 단원별로 줄인다. 다음 우선순위는 `unit-5-1-fraction-simplify`의 `simplify-001`과 `commonden-001`이며 두 은행 모두 추론 문항이 없고 문제군이 5개다. 단원 전체 60문항의 문장·범위·solver·풀이를 함께 보강한다.
