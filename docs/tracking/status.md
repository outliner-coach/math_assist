...
3. 5학년 응용문제 품질 경고 37개를 단원별로 줄인다. 다음 우선순위는 `unit-5-1-fraction-addsub`의 `fracadd-001`과 `fracsub-001`이며 두 은행 모두 K18/A12/R0, 문제군 4개다. 단원 전체 60문항의 문장·범위·solver·풀이를 함께 보강한다.
