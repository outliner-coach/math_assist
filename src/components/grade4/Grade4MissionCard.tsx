        ...
        <div className="space-y-4">
          {mission.answerType === 'choice' ? (
            ...
            <div className="space-y-3">
              <label htmlFor="grade4-integer-input" className="block text-sm font-black text-[#475569]">{expectsDecimal ? '답을 소수로 써요' : '답을 숫자로 써요'}</label>
              <input id="grade4-integer-input" data-testid="grade4-integer-input" inputMode={expectsDecimal ? 'decimal' : 'numeric'} value={textAnswer} disabled={solved}
