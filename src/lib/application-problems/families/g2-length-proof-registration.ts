...
export const G2_LENGTH_PROOF_AUTHORITY_ENTRIES = [
  {
    ...
    manifest: {
      ...
      sourceModule: 'src/lib/application-problems/families/g2-length-proof-registration.ts',
      sourceDigest: 'sha256:3a851c32773b58f0e2307a55cc331f7339a1e7c707a35c4261e832b074c54b27',
  ...
  },
  {
    ...
    manifest: {
      ...
      sourceModule: 'src/lib/application-problems/families/g2-length-proof-registration.ts',
      sourceDigest: 'sha256:de74ebd3effb5449959691f19038e0d3a7bc686aa18c2f8d42a182ea8a49ac33',
  ...
  },
  {
    ...
    manifest: {
      ...
      sourceModule: 'src/lib/application-problems/families/g2-length-proof-registration.ts',
      sourceDigest: 'sha256:055c2da8e08ccc6d06f79f98023c9d69865f6d9b815b04dccd9d5946e4151427',
