...
const definitions = [
  ...
  {
    familyId: 'g2-1-multiplication-missing-groups', cognitiveDomain: 'reasoning' as const, reasoningPattern: 'inverse' as const, estimatedSteps: 3, modelId: 'g2-multiplication-missing-group-count-v1', unknownRole: 'number-of-groups', requiredStudentActions: ['interpret_context', 'infer_missing_value', 'choose_model', 'verify_result'] as const, misconceptionRefs: [],
  ...
  {
    familyId: 'g2-1-multiplication-array-claim', cognitiveDomain: 'reasoning' as const, reasoningPattern: 'error_analysis' as const, estimatedSteps: 3, modelId: 'g2-multiplication-array-claim-v1', unknownRole: 'valid-array-claim', requiredStudentActions: ['interpret_context', 'evaluate_claim', 'convert_representation', 'verify_result'] as const, misconceptionRefs: [ADD],
