...
const grade2PracticeSpecsBySourceId: Record<string, Grade2PracticeSpec> = {
  ...
  'g2-1-multiplication-05': practice('[2수01-10]', 'applying', '한 줄에 창문이 5개씩 있고 모두 4줄입니다. 화분 20개를 창문마다 한 개씩 놓을 때 알맞은 계산과 결론을 고르세요.', '4 x 5 = 20, 남는 화분은 0개', { rows: 4, cols: 5, groups: 4, each: 5, available: 20 }, { learnerGoal: '배열의 전체 수와 준비한 수를 비교해요', answerType: 'label', answerConfig: labelAnswerConfig, choicesTemplate: ['4 x 5 = 20, 남는 화분은 0개', '4 + 5 = 9, 남는 화분은 11개', '5 x 5 = 25, 화분은 5개 부족'], taskActions: ['model', 'compare', 'calculate'] }),
  ...
  'g2-2-table-graph-03': practice('[2수04-02]', 'applying', '운동 원자료 축구, 야구, 야구, 피구, 야구, 축구를 종목별로 분류하여 표를 완성할 때 야구 칸에 쓸 수는 얼마일까요?', '3', { categories: '축구,야구,피구', counts: '2,3,1', target: '야구', countDisplay: 'marks' }, { learnerGoal: '운동 원자료를 분류해 표를 완성해요', visualModel: 'classification-table', taskActions: ['classify', 'construct'] }),
