...
- 기존 전역 마스코트는 390px에서 `C · 10문제`와 `정답 확인`,
  1024px에서 개념 화면의 오른쪽 5/10문제 버튼과 겹쳤다.
- 개념·연습 화면의 고정 행동 영역에 모바일 48px, `md` 이상 320px
  오른쪽 안전 영역을 두고 Grade 6 두 줄 개념 행동 영역만큼 문서 하단
  여백을 늘렸다.
- E2E는 390×844·1024×768에서 개념·연습 버튼과 동반자의 실제 DOM
  사각형 교차 면적 0을 검사한다.
