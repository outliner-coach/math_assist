...
- ✅ 약분과 통분(기약분수/약분/통분)
- ✅ 분수의 덧셈과 뺄셈(이분모 분수)
- ✅ 다각형의 둘레와 넓이(SVG 도형 + 둘레/넓이 계산)

### 6.2 5-2
- ✅ 수의 범위와 어림하기(반올림/올림/버림)
- ✅ 분수의 곱셈(분수×자연수, 분수×분수)
- ✅ 합동과 대칭(SVG 합동 도형 + 선대칭/점대칭)
- ✅ 소수의 곱셈(소수×자연수, 소수×소수)
- ✅ 직육면체(SVG 입체도형 + 전개도)
- ✅ 평균과 가능성(평균 구하기)
...
- 총 9개 단원, 15개 개념의 수·연산/규칙 문제 기반 완성

### Phase 3 (도형 확장) ✅ 완료 (2026-07-18)
- SVG 도형 문제: 다각형의 둘레와 넓이, 합동과 대칭, 직육면체
- 도형 단원별 20개 문제 유형, 개념별 연습 세트 A/B/C 각 10개 템플릿
- 각 세트는 난이도 1/2/3을 4/4/2 비율로 구성
- 제출 전 정답 정보 비공개 및 제출 후 SVG 해설 표시
- 템플릿 힌트와 오답 다시 풀기 흐름 연동
- AI 자연어 힌트는 비결정적 보조 기능으로 추후 선택 구현
